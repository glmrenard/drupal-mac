...
To use these stylesheets, rename the files and d7dev_theme with the name of your theme.
...
d7dev_theme-alpha-default-narrow.css  
...
d7dev_theme-alpha-default-normal.css
...
d7dev_theme-alpha-default-wide.css
